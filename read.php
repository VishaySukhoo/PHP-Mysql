            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        <label>Logo</label>
                        <?php if($row['userPic']==NULL){ ?> <img src="upload/Empty.png" class="img-rounded" width="250px" height="250px" /><?php }
                         else{ ?>
                                 	 
                                 	
                          <img src="upload/<?php echo $row["userPic"]; ?>" class="img-rounded" width="250px" height="250px" /> <?php } ?>
                    </div>
