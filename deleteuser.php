...
if(isset($_POST["id"]) && !empty($_POST["id"])){
    ...
    $sql = "DELETE FROM users,Ad USING users INNER JOIN Ad ON users.id = Ad.userid  WHERE users.id= ?";
                ...
                <div class="col-md-12">
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                        <div class="alert alert-danger fade in">
                            ...
                            <p>Are you sure you want to delete this record? All Ads posted by this user will also get deleted</p><br>
                            <p>
                                <input type="submit" value="Yes" class="btn btn-danger">
                                <a href="manageusers.php" class="btn btn-default">No</a>
                            </p>
                        </div>
                    </form>
                </div>
