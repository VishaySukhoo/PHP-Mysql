...
a:active {
    ...
    $('.search-box input[type="text"]').on("keyup input", function(){
        ...
        if(inputVal.length){
            $.get("backend-searchmanage.php", {term: inputVal}).done(function(data){
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-header clearfix">
                        ...
                        <a href="managecreate.php" class="btn btn-success pull-right">Add New Business</a>
                    </div>
                    <?php
                    // Include config file
                                ...
                                while($row = $result->fetch_array()){
                                    echo "<tr>";
                                 	 ...
                                 	 <?php } else{ ?>
                                 	  ...
                                 	  echo"</td>";
                                        echo "<td>";
                                            echo "<a href='manageread.php?id=". $row['id'] ."' title='View Record' data-toggle='tooltip'><span class='glyphicon glyphicon-eye-open'></span></a>";
                                            echo "<a href='manageupdate.php?id=". $row['id'] ."' title='Update Record' data-toggle='tooltip'><span class='glyphicon glyphicon-pencil'></span></a>";
                                            echo "<a href='managedelete.php?id=". $row['id'] ."' title='Delete Record' data-toggle='tooltip'><span class='glyphicon glyphicon-trash'></span></a>";
                                        echo "</td>";
                                    echo "</tr>";
                                }
                                echo "</tbody>";                            
