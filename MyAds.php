            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-header clearfix">
                        <h2 class="pull-left">Recently Posted</h2>
                        <a href="create.php" class="btn btn-success pull-right">Add New Business</a>
                    </div>
                    <?php
                    // Include config file
                    ...
                    $sql = "SELECT * FROM Ad WHERE userid={$_SESSION['usr_id']}";
